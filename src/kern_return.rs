...
pub const KERN_DENIED: kern_return_t = 53;
pub const KERN_MISSING_KC: kern_return_t = 54;
pub const KERN_INVALID_KC: kern_return_t = 55;
pub const KERN_NOT_FOUND: kern_return_t = 56;
pub const KERN_INVALID_GUARD_OBJECT_SLOT: kern_return_t = 57;
